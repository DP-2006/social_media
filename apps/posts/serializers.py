...
class DebugPostInfoSerializer(serializers.Serializer):
    """Serializer for debug post info"""
...
class DebugUserPostsResponseSerializer(serializers.Serializer):
    """Serializer for debug user posts response"""
    debug_info = serializers.DictField()
    posts_count = serializers.IntegerField()
    posts = DebugPostInfoSerializer(many=True)